...
export const AIRGAP_BUILD_ROOT = path.join(STORAGE_ROOT, 'airgap-builds')
export const AIRGAP_BUILD_UPLOADS_ROOT = path.join(AIRGAP_BUILD_ROOT, 'uploads')
export const AIRGAP_BUILD_LOGS_ROOT = path.join(AIRGAP_BUILD_ROOT, 'logs')
export const AIRGAP_BUILD_STATE_PATH = path.join(AIRGAP_BUILD_ROOT, 'state.json')
