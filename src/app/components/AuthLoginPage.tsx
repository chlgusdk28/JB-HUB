                    ...
                    <button
                      ...
                      className={`rounded-2xl border px-4 py-4 text-left transition ${
                        isSelected
                          ...
                          : 'border-slate-200 bg-white/90 text-slate-900 hover:border-slate-400 hover:bg-white'
                      }`}
                    >
                      ...
                      <div className={`mt-4 text-xs font-medium ${isSelected ? 'text-slate-200' : 'text-slate-500'}`}>
