        ...
        <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
          <div className="page-summary-strip">
            <div className="page-summary-item">
              <span className="page-summary-label">마일스톤</span>
              <span className="page-summary-value">{milestones.length}</span>
            </div>
            <div className="page-summary-item">
              <span className="page-summary-label">완료 단계</span>
              <span className="page-summary-value">{completedMilestones}</span>
            </div>
            <div className="page-summary-item">
              <span className="page-summary-label">진행 중</span>
              <span className="page-summary-value">{activeMilestones}</span>
            </div>
            <div className="page-summary-item">
              <span className="page-summary-label">전체 진행률</span>
              <span className="page-summary-value">{overallProgress}%</span>
            </div>
          </div>

          <button type="button" onClick={() => setShowAddForm((previous) => !previous)} className="glass-inline-button">
            <Plus className="h-4 w-4" />
            {showAddForm ? '입력 닫기' : '마일스톤 추가'}
          </button>
        </div>

        <p className="page-toolbar-note">각 단계의 상태와 작업 진행률이 같은 규칙으로 보이도록 정리해 복잡도를 낮췄습니다.</p>
